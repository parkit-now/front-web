...
const TEMPLATES: AuditTemplate[] = [
  { t: 'modificó la tarifa de la Zona A', sev: 'warn' },
  ...
  { t: 'creó la Zona D con 12 plazas de tipo Auto', sev: 'info' },
  { t: 'cambió el método de pago "Cripto" a inactivo', sev: 'info' },
  { t: 'eliminó la plaza B-05 (tipo Moto)', sev: 'warn' },
  ...
  { t: 'editó el nombre de Zona B a "Subsuelo 1"', sev: 'info' },
  { t: 'eliminó plazas de tipo moto de Zona C', sev: 'warn' },
